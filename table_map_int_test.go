...
// func TestTableMapInt(t *testing.T) {

// 	tmi := CreateTableMapInt("test/tbl/")
...
// 	_, _, _, err = tmi.Set(ItemInt{Key: 82739,
...
// 	_, n, eq, err := tmi.Set(ItemInt{Key: 82734,
// 		FieldsInt: map[string]int64{"b": 0,
// 			"c":    5,
// 			"tif1": 10},
// 		FieldsString: map[string]string{"b": "0",
...
// 	out, n, eq, err := tmi.Set(ItemInt{Key: 82734,
// 		FieldsInt: map[string]int64{"b": 0,
// 			"c":    5,
// 			"tif1": 5}})
// 	if err != nil {
...
// 	_, _, _, err = tmi.Set(ItemInt{Key: 82734,
// 		FieldsInt: map[string]int64{"b": 0,
// 			"c":    5,
// 			"tif1": 5}})
...
// 	_, _, _, err = tmi.Set(ItemInt{Key: 82732,
// 		FieldsInt: map[string]int64{"b": 0,
// 			"c":    5,
// 			"tif1": 5}})
// 	if err != nil {
...
// 	_, _, _, err = tmi.Set(ItemInt{Key: 82733,
// 		FieldsInt: map[string]int64{"b": 0,
// 			"c":    5,
// 			"tif1": 15}})
// 	if err != nil {
...
// 	tmi2 := CreateTableMapInt("test/tbl/")
// 	err = tmi2.Load()
// 	if err != nil {
// 		t.Fatal(err)
// 	}
